...
mystring mystl::operator+(const mystring& origin, const mystring& addend)
{
...
ostream& mystl::operator <<(ostream& outs, const mystring& source)
{
	outs << source.sequence;
	return outs;
}

istream& mystl::operator >>(istream& is, mystring& target)
{
	char temp[128];
	is>>temp;
	target.clear();
...
bool mystl::operator== (const mystring& s1, const mystring& s2)
{
...
istream& mystl::getline(istream& is, mystring& target)
{
	char temp[128];
	is>>temp;
	target.clear();
